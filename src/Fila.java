// Classe genérica para uma Fila (Queue)
public class Fila <T>
{    // Classe que representa um nó na fila
    ...
    {
        System.out.println("Tamanho: " + size); // Retorna o valor de 'size'
    }
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println();
        System.out.println("** Fila tipo inteiro criada **");
        fila.printQueue(); // Estado atual da fila
        fila.printSize();  // Tamanho atual da fila

        // Adiciona elementos
        System.out.println();
        System.out.println("** Adicao de elementos **");
        fila.enQueue(00);
        fila.enQueue(10);
        fila.enQueue(20);
        fila.enQueue(30);
